        ...
        <div class="left">
            <div class="content">
                ...
                <el-skeleton   :loading="loading" animated>
                    <template #template>
                        <el-skeleton style="margin-bottom: 10px;" :rows="7"></el-skeleton>
                    </template>
                    <template #default>
            ...
            <el-skeleton   :loading="loading" animated>
                <template #template>
                    <div class="talk-inner">
                        <el-skeleton-item variant="text" style="width: 120px; height: 16px; border-radius: 5px;"></el-skeleton-item>
                        <el-skeleton-item variant="text" style="width: 120px; height: 16px; border-radius: 5px;"></el-skeleton-item>
                        <!-- <el-skeleton style="margin-bottom: 10px;" :rows="0"></el-skeleton> -->
                    </div>
                </template>
                <template #default>
                    <div class="talk-inner">
