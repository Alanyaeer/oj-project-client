...
const clickWhich = (type)=>{
    let currentStyle =  document.getElementsByClassName("iteminner")[current.value].style 
    currentStyle.backgroundColor="white"
    let t = document.getElementsByClassName("iteminner")[type].style 
    console.log(t);
    current.value = type
    t.backgroundColor="#F2F3F4"
}
onMounted(()=>{ 
    clickWhich(0)
    questionList.value = 
