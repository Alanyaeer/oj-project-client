...
<div class="container">
    <div class="content">
        ...
        <div class="content-content">
            <mavon-editor ref="md" previewBackground="#ffffff" :boxShadow="false" :subfield="false" :toolbarsFlag="false" defaultOpen="preview" v-model="article.content" style="border: none; padding: none; width: 800px;" />
