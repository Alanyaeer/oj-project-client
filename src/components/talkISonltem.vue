...
<template>
    ...
    <div class="container">
        ...
        <div class="bottom">
            <mavon-editor class="content-showt" ref="md" previewBackground="#F7F7F7" :boxShadow="false" :subfield="false" :toolbarsFlag="false" defaultOpen="preview" v-model="talkInfo.content" style="border: none; padding: none; width: 700px;" />
        ...
        <div class="footer" >
            ...
            <div @click="showTheEditor" class="item-icon-status" style="left: 370px">
